...
namespace FUIEditor
{
    ...
    public static class FUICodeSpawner
    {
        ...
        // 代码生成路径
        public const string FUIAutoGenDir = "../ET/Assets/Scripts/ModelView/Components/FairyGUI/FUI_AutoGen";
        public const string ModelViewCodeDir = "../ET/Assets/Scripts/ModelView/Components/FairyGUI/FUI_Panel";
        public const string HotfixViewCodeDir = "../ET/Assets/Scripts/HotfixView/Components/FairyGUI/FUI_Panel";
